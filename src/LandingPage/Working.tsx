...
import { work } from "../images/Data/Data";
...
const Working=()=>{
    ...
    <div className="text-lg  mb-10 mx-auto text-mine-shaft-300 text-center w-1/2">Effortlessly navigate through the process and land your dream job.
    </div>
    <div className="flex px-[13%] justify-between items-center">
